    ...
    <>
      <aside id="sidebar" className="sidebar" style={{borderRadius:"0px 33px 33px 0px"}}  >
        ...
        <li className="nav-item">
            <NavLink className="nav-link " to = {`/Admin?account=${account}`} style={{borderRadius:"14px"}}>
          ...
          <li className="nav-item">
            <NavLink className="nav-link " to = {`/addHospital?account=${account}`} style={{borderRadius:"14px"}}>
              <i className="bi bi-grid">
                <FaHospitalAlt />
              </i>
          ...
          <li className="nav-item">
            <NavLink className="nav-link" to={`/addDoctor?account=${account}`} style={{borderRadius:"14px"}}>
              <i className="bi bi-grid">
                <FaStethoscope />
              </i>
